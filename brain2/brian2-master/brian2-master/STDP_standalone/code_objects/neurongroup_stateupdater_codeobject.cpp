...
void _run_neurongroup_stateupdater_codeobject()
{
    ...
    ///// CONSTANTS ///////////
    const double Ee = 0.0;
const double El = - 0.074;
const int32_t N = 1;
const size_t _numdt = 1;
const size_t _numge = 1;
const double taue = 0.005;
const double taum = 0.01;
const size_t _numv = 1;
    ...
    const double _lio_1 = 1.0f*(- dt)/taue;
    const double _lio_2 = 1.0f*dt/taum;
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        const double _ge = (_lio_1 * ge) + ge;
        const double _v = (_lio_2 * ((El + (ge * (Ee - v))) - v)) + v;
        ge = _ge;
        v = _v;
